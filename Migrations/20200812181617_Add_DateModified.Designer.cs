...
namespace webapiProject.Migrations
{
    ...
    [Migration("20200812181617_Add_DateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webapiProject.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnName("CourseID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webapiProject.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("webapiProject.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnName("InstructorID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webapiProject.Models.CourseInstructor", b =>
                {
                    b.HasOne("webapiProject.Models.Course", "Course")
                    ...
                    b.HasOne("webapiProject.Models.Person", "Instructor")
                        .WithMany("CourseInstructor")
            ...
            modelBuilder.Entity("webapiProject.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("webapiProject.Models.Person", "Student")
                        .WithMany("Enrollment")
            ...
            modelBuilder.Entity("webapiProject.Models.OfficeAssignment", b =>
                {
                    b.HasOne("webapiProject.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("webapiProject.Models.OfficeAssignment", "InstructorId")
